...
python test_finetuned_rework.py -z $WORK/evaluate_model/ -p ${SLURM_ARRAY_TASK_ID} -e 3 -c 16 -b 2 -s "1" -t "train" --arg_gpu "v100" -a 2
python test_finetuned_rework.py -z $WORK/evaluate_model/ -p ${SLURM_ARRAY_TASK_ID} -e 3 -c 16 -b 2 -s "1" -t "eval" --arg_gpu "v100" -a 2
