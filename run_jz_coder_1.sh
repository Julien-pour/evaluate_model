...
python test_finetuned_rework.py -z $WORK/evaluate_model/ -p ${SLURM_ARRAY_TASK_ID} -e 2 -c 16 -b 8 -s "1" -t "train" 
python test_finetuned_rework.py -z $WORK/evaluate_model/ -p ${SLURM_ARRAY_TASK_ID} -e 2 -c 16 -b 8 -s "1" -t "eval" 

python test_finetuned_rework.py -z $WORK/evaluate_model/ -p ${SLURM_ARRAY_TASK_ID} -e 3 -c 16 -b 8 -s "1" -t "train" 
python test_finetuned_rework.py -z $WORK/evaluate_model/ -p ${SLURM_ARRAY_TASK_ID} -e 3 -c 16 -b 8 -s "1" -t "eval" 

python test_finetuned_rework.py -z $WORK/evaluate_model/ -p ${SLURM_ARRAY_TASK_ID} -e 1 -c 16 -b 8 -s "1" -t "train"
python test_finetuned_rework.py -z $WORK/evaluate_model/ -p ${SLURM_ARRAY_TASK_ID} -e 1 -c 16 -b 8 -s "1" -t "eval" 
