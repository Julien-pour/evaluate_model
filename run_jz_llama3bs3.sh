...
python test_finetuned.py -z $SCRATCH/evaluate_model/ -p ${SLURM_ARRAY_TASK_ID} -e 2 -c 31 -b 12 -m "open_llama_3b_v2" -s "31" -t "train" -f False
python test_finetuned.py -z $SCRATCH/evaluate_model/ -p ${SLURM_ARRAY_TASK_ID} -e 2 -c 31 -b 12 -m "open_llama_3b_v2" -s "31" -t "eval" -f False
