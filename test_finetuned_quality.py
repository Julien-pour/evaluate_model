...
name = args.path_archive.split("split_quality/")[1].split(".json")[0]#list_name[path_train_idx]
...
name_json_save_all = args.base_path+f"save_results/passk_quality_lr-1e6.json"#.split("/")[1]
